...
function SliderUnlock(elm, options, success, always) {
    ...
    var opts = {
        labelTip: typeof(options.labelTip)!=="undefined" ? options.labelTip : "滑动我到右侧登录",
        successLabelTip: typeof(options.successLabelTip)!=='undefined' ? options.successLabelTip : "解锁成功",
